...
def get_args_parser():
    ...
    parser.add_argument(
        "--data_path",
        default="/vol/vssp/SF_datasets/still/ImageNet/ILSVRC2012/TrainingSet/",
        type=str,
...
def train_mugs(args):
    ...
    # print(args.output_dir + '/train.log')
    logger = utils.get_logger(str(args.output_dir) + "/train.log")
    logger.info(args)
